//! Common helper functions for authentication integration tests.

#![allow(dead_code)] // This is a library of test helpers, so not all functions may be used at once.

use pg_vault::auth::{AuthError, AuthResult};
